...
class HashTable
{
    private:
        ...
        const static double c1 = 0.5, c2 = 0.5;
    public:
        ...
        {
            return (int)(auxiliaryHash(key) + c1 * probe_number + c2 * probe_number * probe_number) % table_size;
        }
...
{
    int size;
    cout << "Enter the size of hashtable (preferably a power of 2): ";
    cin >> size;
    HashTable h(size);
    int num;
    while(true)
